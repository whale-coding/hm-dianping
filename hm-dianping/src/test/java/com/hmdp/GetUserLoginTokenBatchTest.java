...
/**
 * @Classname: GetUserLoginTokenBatch
 * @Date: 2025/2/27 16:33
 * @Author: 聂建强
 * @Description: 批量获取登录用户的Token
 * tips:使用的时候需要注释掉UserServiceImpl文件中的login方法的校验验证码的那部分代码！！！！
 */

@SpringBootTest
public class GetUserLoginTokenBatchTest {
    ...
    public void function(){
        String loginUrl = "http://localhost:8088/api/user/login"; // 替换为实际的登录URL
        String tokenFilePath = "/Users/macbook/workspace/Java/学习资料/黑马-Redis入门到实战教程/02-实战篇/资料/tokens.txt"; // 存储Token的文件路径
